  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 15 }}>
        ...
        <Text style={{ fontSize: 20, fontWeight: 'bold' }}>Customer Profile</Text>
      </View>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <View
          style={{
            ...
            borderBottomWidth: 1,
            borderColor: '#ddd',
            backgroundColor: '#045c5a',  // Updated background color
            borderRadius: 10,
            paddingTop: 20,
          }}
        >
          ...
          />
          <Text style={{ fontSize: 24, fontWeight: 'bold', marginBottom: 5, color: '#fff' }}>
            {customer.name}
          </Text>
          <Text style={{ fontSize: 16, color: '#fff', marginBottom: 2 }}>
            {customer.email}
          </Text>
          <Text style={{ fontSize: 16, color: '#fff' }}>{customer.phone}</Text>
        </View>

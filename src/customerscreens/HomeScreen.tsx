...
console.log('open drawer function from navigation ',navigation.openDrawer);
            ...
            <ScrollView bounces={false}>
                <View style={styles.home}>
                    ...
                    <View style={styles.view1}>
                        <View style={styles.view8}>
                            ...
                            <TouchableOpacity onPress={() => { navigation.navigate("RequestScreen", { state: 0, drawer:drawer }); }}>
                ...
                <View style={styles.view5}>
                    <View style={styles.view6}>
                        ...
                        <View>
                            <Text style={{ fontSize: 18, color: colors.black }}>123 Pretoria Rd</Text>
                ...
                <View style={{ ...styles.view5, borderBottomWidth: 0 }}>
                    <View style={styles.view6}>
                        ...
                        <View>
                            <Text style={{ fontSize: 18, color: colors.black }}>32 Menlyn Rd</Text>
                            <Text style={{ color: colors.grey3 }}>Klipfontein 83-Ir, Boksburg</Text>
                        </View>
                    </View>
                    <View>
